...
---
## HTTP
- [HTTP/1.1](https://tools.ietf.org/html/rfc2068): connection reuse
- [HTTP/2](https://tools.ietf.org/html/rfc7540): multiplex(all resource from single connection)
- [HTTP/3](): 

---
## HTTP/3 will not use TCP anymore..

**QUIC**(Quick UDP Internet Connections, by google, 2012)

<img src="https://2.bp.blogspot.com/-4KrRSDN2Rkc/WyFSCkKxljI/AAAAAAAAF24/OzBCJNEEQH0ynaB_QmSvDeEQV-cRU05HgCLcBGAs/s1600/gcp-cloud-cdn-performance.gif" height=600>
